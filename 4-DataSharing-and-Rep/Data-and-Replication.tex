...
{ % all template changes are local to this group.
    ...
    \begin{frame}[plain]
        \begin{tikzpicture}[remember picture,overlay]
            \node[at=(current page.center)] {
                \includegraphics[width=\paperwidth]{ClemensReplication.PNG}
            };
        \end{tikzpicture}
     \end{frame}
}
...
{ % all template changes are local to this group.
    ...
    \begin{frame}[plain]
        \begin{tikzpicture}[remember picture,overlay]
            \node[at=(current page.center)] {
                \includegraphics[width=\paperwidth]{DuvendackReplicationJournals.PNG}
            };
        \end{tikzpicture}
     \end{frame}
...
\setbeamertemplate{navigation symbols}{}
    \begin{frame}[plain]
        \begin{tikzpicture}[remember picture,overlay]
            \node[at=(current page.center)] {
                \includegraphics[width=\paperwidth]{JanzReplicationJournals.PNG}
            };
        \end{tikzpicture}
     \end{frame}
}
...
{ % all template changes are local to this group.
    ...
    \begin{frame}[plain]
        \begin{tikzpicture}[remember picture,overlay]
            \node[at=(current page.center)] {
                \includegraphics[width=\paperwidth]{ManyLabs.PNG}
            };
        \end{tikzpicture}
     \end{frame}
...
\setbeamertemplate{navigation symbols}{}
    \begin{frame}[plain]
        \begin{tikzpicture}[remember picture,overlay]
            \node[at=(current page.center)] {
                \includegraphics[width=\paperwidth]{Crowdsourcing.PNG}
            };
        \end{tikzpicture}
     \end{frame}
}
